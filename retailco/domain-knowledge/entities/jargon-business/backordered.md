...
Orders across the EU region were immediately backordered despite inventory being available at distribution centers. Suspected root cause involves human error during configuration or migration — possibly incorrect region selection affecting how the system resolves inventory availability for EU markets.