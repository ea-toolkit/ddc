# CLAUDE.md - DDC Demo Knowledge Base

> This is an **empty knowledge base** for demonstrating the DDC (Demand-Driven Context) methodology.

## What This Is

This folder is a self-contained domain knowledge base that starts empty. It exists to demonstrate how DDC works: an agent tries to answer a domain question, fails because the KB is empty, identifies what's missing, and then curates structured knowledge from rough human input.
